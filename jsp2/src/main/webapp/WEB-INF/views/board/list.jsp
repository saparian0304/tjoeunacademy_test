...
<body>
		...
		<table border="1" width="90%">
			<tr>
				<td align="center">
					...
					<input type="text" name="searchWord" value="<c:if test="${!empty map.searchWord }">${map.searchWord }</c:if>">
	...
	<c:choose>
		<c:when test="${empty map.boardLists }">
			<tr>
		...
		<c:otherwise>
			<c:forEach items="${map.boardLists }" var="row" varStatus="loop">
				<tr align="center">
					<td>
